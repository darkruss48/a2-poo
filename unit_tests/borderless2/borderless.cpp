...
######################
Ce test unitaire sur la grille torique initialise une grille complètement remplie. (1 seconde d'attente entre chaque calcul de population)
...
void update()
{
    ...
    std::srand(std::time(0)); // 1 secondes d'attente
...
int main() {
    ...
    while (window.isOpen()) {
        ...
        sf::sleep(sf::milliseconds(1000)); // Attente d'une seconde
    }
