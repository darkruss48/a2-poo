/*
Ce test unitaire permet de vérifier le multithreading.
Mettre 1 thread pour annuler le multi-threading

Compilez ce programme avec cette commande (Linux) :
make

Executer le test unitaire de cette manière :
./main reset test canon 80 80
time ./main console 300 test
