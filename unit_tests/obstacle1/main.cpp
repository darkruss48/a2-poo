...
./main reset test glider 30 30 && ./main window test


######################
Ce test unitaire initialise une grille de 30x30 avec une cellule obstacle vivante en (8, 8).
Il y a aussi un planeur traversant la grille.
*/
