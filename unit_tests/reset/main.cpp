/*
Ce test unitaire permet de générer une grille aléatoire de 80x80 cellules avec 1% de cellules obstacles.
Compilez ce programme avec cette commande (Linux) :
make

Executer le premier test unitaire de cette manière :
./main reset test glider 5 5 && ./main window test

Executer le deuxième test unitaire de cette manière :
./main reset test canon 50 50 && ./main window test

Executer le troisième test unitaire de cette manière :
